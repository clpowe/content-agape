			...
			vueform: {
				steps: {
					page0: {
						...
						elements: [
							...
							'How many children do you have and what are their ages?_copy',
							'T-Shirt Size',
							'How did you hear about Agape Christian Bar Prep?'
						]
					},
					page1: {
						label: 'Education',
				...
				schema: {
					...
					'How many children do you have and what are their ages?_copy': {
						...
						description:
							'Do you have any other obligations that could potentially take away from your study time such as caring for a sick family member, planned trips, etc.?  If so, please explain.'
					},
					'T-Shirt Size': {
						type: 'select',
						items: [
...
<style>
	...
	.vf-my-form:root {
		...
		--vf-radius-input: 0.5rem;
		--vf-radius-input-sm: 4px 4px 4px 4px;
		--vf-radius-input-lg: 4px;
		--vf-radius-btn: 999999px;
